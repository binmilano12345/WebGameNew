...
public class DataOutputStream
{
    ...
    BinaryWriterIns ClientOutput;

    public DataOutputStream(BinaryWriterIns _clientOutput)
    {
    ...
    public void Write(sbyte[] b)
    {
        ...
        ClientOutput.Write(bb, 0, b.Length);
        IncCount(b.Length);
    }

    public void WriteBoolean(Boolean v)
    {
        ClientOutput.WriteByte(v ? 1 : 0);
        IncCount(1);
    }

    public void WriteByte(int v)
    {
        ClientOutput.WriteByte(v);
        IncCount(1);
    }
    public void WriteByteNew(int v)
    {
